...
> 原文:[https://www.javatpoint.com/angular-material-swipe](https://www.javatpoint.com/angular-material-swipe)

角度材质滑动功能是用于移动设备的角度指令。UX 模式仅用于移动设备，不能制作响应站点。要在桌面上启动滑动手势，您可以在滑动功能的帮助下单击、按住并向右、向左、向上或向下拖动。

以下说明用于处理刷卡。

*   **MD-向下扫动**:用于确定任意元素向下扫动时的自定义行为。
*   **MD-上扫**:用于元素上扫时生成自定义行为。
*   **MD-swipe-left**:MD-swipe-left 是一个角度指令，用于指定向左滑动元素时的自定义行为。
...
![Angular Material Swipe](../Images/bd446bd0d02966910ad2913c4649cf91.png)
...
![Angular Material Swipe](../Images/17f0efb117b0759fa9e7f941f506559e.png)
