...
> 原文:[https://www.javatpoint.com/polymer-iron-form](https://www.javatpoint.com/polymer-iron-form)

聚合铁表单是一个 HTML 表单元素，用于验证和提交任何自定义元素和本机元素。GET 和 POST 方法都受支持，ironajax 元素用于将数据提交给动作 URL。
