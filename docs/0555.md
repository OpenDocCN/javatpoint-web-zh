...
![JavaScript timer](../Images/fae65410a7d2495a165a306e83cd88cb.png)

点击**点击此处**按钮，剩余代码将在 3 秒后执行。3 秒(3000 毫秒)后，网页上会显示一条消息**欢迎来到 javaTpoint** 。

![JavaScript timer](../Images/28b2c400c08a551cd3ee3c190ebc429a.png)
...
![JavaScript timer](../Images/8624433619163c23ea212c93479de421.png)

4 秒后，JavaScript 函数将调用并开始显示时间。这将每四秒钟重复显示您的系统时间。

![JavaScript timer](../Images/7dc73c2f2d6fa6e4b404b94491f45b27.png)
...
![JavaScript timer](../Images/f58b981e42985953aa5b702b188ec6e5.png)

点击此**点击此处**按钮，waitAndshow()将开始每 4 秒钟在网页上重复打印消息**欢迎来到 Javatpoint** 。

![JavaScript timer](../Images/c1dff74194bb9f78b386f35e6278813e.png)
...
![JavaScript timer](../Images/394def23d333d7ef0492225c5cdb9a7b.png)

计时器每三秒钟显示一次更新的时间。如果点击此**停止时钟**按钮，计时器将被禁用，并停止显示更新的时间。

![JavaScript timer](../Images/9f57c071130ea208ecf7d351c4283907.png)
