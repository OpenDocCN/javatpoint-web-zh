...
> 原文:[https://www.javatpoint.com/bootstrap-progress-bar](https://www.javatpoint.com/bootstrap-progress-bar)

进度条显示用户在进程中的进度。在引导中，有几种类型的进度条。

**班。进度< div >元素内的**用于在引导中创建默认进度条。
