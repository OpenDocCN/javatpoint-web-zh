...
> 原文:[https://www.javatpoint.com/bootstrap-spinners](https://www.javatpoint.com/bootstrap-spinners)

微调器也称为**加载指示器**。它用于显示/指示我们项目的加载状态。自举使用了**。spinner** 类创建一个 spinner。

我们使用下面的语法在[引导](https://www.javatpoint.com/bootstrap-tutorial)中创建一个微调器-
