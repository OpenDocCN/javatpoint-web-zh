...
> 原文:[https://www . javatpoint . com/read-more-functional-use-jquery](https://www.javatpoint.com/read-more-functionality-using-jquery)

在本文中，我们将借助各种示例在 jQuery 中创建 read more 功能。在本文的开头，我们将了解 jQuery 的基础知识，并阅读更多的功能。之后，我们会理解这篇文章，用几个例子。

## jQuery 是什么意思？

jQuery 中使用了“读取更多”功能，以便在用户单击“读取更多”按钮时加载更多数据。[引入 JQuery](https://www.javatpoint.com/jquery-tutorial) 来简化 [HTML](https://www.javatpoint.com/html-tutorial) DOM 树的遍历和操纵以及事件处理、 [CSS 动画](https://www.javatpoint.com/css-animation)和 [Ajax](https://www.javatpoint.com/ajax-tutorial) 。它是免费的开源软件。

**我们来举几个借助 jQuery 多读的例子。**
...
在上面的例子中，我们在 jquery 中创建了 read more 功能。

**输出:**

当用户点击阅读更多按钮时，将显示以下输出。

![Read more functionality using jQuery](../Images/f19f320e4eef6cf30fc890a7667fc311.png)
...
在上面的例子中，我们在 jQuery 中创建了一个 read more 功能。当用户点击“阅读更多”按钮时，文本被加载。

**输出:**

下面是这个例子的输出

![Read more functionality using jQuery](../Images/e42a03d59c4c66b6c55fcbfc26b153c7.png)
