...
> 原文:[https://www . javatpoint . com/framework 7-inline-picker-date-time](https://www.javatpoint.com/framework7-inline-picker-date-time)
...
让我们举一个例子来演示框架 7 中内嵌选择器/日期时间的使用:
