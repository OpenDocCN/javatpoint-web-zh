...
> 原文:[https://www.javatpoint.com/materialize-css-tables](https://www.javatpoint.com/materialize-css-tables)

在物化 CSS 中，您可以使用各种样式显示不同类型的表格。以下是各种样式的列表:
...
让我们举个例子来演示物化 CSS 中不同类型的表。该示例包含简单表、剥离表、居中表和响应表。
