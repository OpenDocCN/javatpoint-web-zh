...
> 原文:[https://www . javatpoint . com/framework 7-switch-tab-from-nav bar](https://www.javatpoint.com/framework7-switch-tabs-from-navbar)

它用于将选项卡放置在导航栏中，便于您在它们之间翻转，看起来像导航栏。

### 例子

让我们举一个例子来演示如何在 Framework7 中使用导航栏中的切换标签:
...
[Test it Now](https://www.javatpoint.com/oprweb/test.jsp?filename=framework7tabsfromnavbar)