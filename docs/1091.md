...
> 原文：<https://www.javatpoint.com/bootstrap-alternatives>
...
骷髅是**最好的也是最受欢迎的轻量级**Bootstrap 替代品。它是由**戴夫·加马奇**开发的。它只提供重要的**组件，如按钮、列表、表单、表格、链接、输入等**来轻松创建有吸引力的网站。它通常使用 **12 列网格**系统。
...
UIKit 是**一个自由、响应迅速、轻量级、开源、易用、快速、强大的前端框架**。它是最好的 Bootstrap 程序替代品之一，包括各种用户界面组件，如默认值、布局、导航、元素、公共、网格和 [JavaScript](https://www.javatpoint.com/javascript-tutorial) 。该框架用于开发快速而强大的 web 界面。
...
HTML KickStart 包含 [HTML](https://www.javatpoint.com/html-tutorial) 、 [CSS](https://www.javatpoint.com/css-tutorial) 和 JavaScript 组件，这些组件允许开发人员节省构建基于网络的网站的时间。它允许开发人员快速轻松地创建响应性网站，而无需花费更多时间进行设计。因为它是基于推特 Bootstrap 的，所以它提供了字体牛逼的图标支持。
...
*   与 Bootstrap 和基础框架相比，Kickstrap 是一个非常轻量级的框架。
*   它不需要 jQuery 插件。
*   这是最大限度减少问题的最佳框架。
*   它使用了最新版本的推特 Bootstrap。
...
Materialize 是最好的 Bootstrap 替代方法之一。它的用户界面组件类似于 Bootstrap。它基于 Material 设计(一种由谷歌创建的设计语言)原则。它提供了 Sass mixins、拖出式移动菜单、涟漪效果动画等等。它为最终用户提供移动和桌面友好的网络界面。

![Bootstrap Alternatives](img/aa8cea27d1247c7cce9474ddf6bca4e8.png)

**优点:**

*   Materialize 在移动设备上提供各种特定的插件。
*   它提供了更好的用户体验。
*   它提供多种现代组件。
...
点击以下链接访问 Materialize 官网-[https://materializecss.com/](https://materializecss.com/)
