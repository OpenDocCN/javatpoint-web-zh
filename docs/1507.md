...
> 原文:[https://www.javatpoint.com/materialize-css-collapsible](https://www.javatpoint.com/materialize-css-collapsible)

可折叠或手风琴用于获得各种预定义的视觉效果和行为增强，以显示各种类型的手风琴。物化 CSS 提供了不同的 CSS 类来应用这些可折叠的。

| 索引 | 类别名 | 描述 |
|  | 可拆卸的 | 它用于将元素标识为物化可折叠组件。ul 元素必需。 |
...
![Materialize collapsible 1](../Images/24f685013c4d13aa9158671bab85377d.png)