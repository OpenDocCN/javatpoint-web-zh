...
> 原文:[https://www.javatpoint.com/framework7-animated-tabs](https://www.javatpoint.com/framework7-animated-tabs)

在 Framework7 中，您可以使用简单的过渡(动画)来切换选项卡，并使用附加的类选项卡-动画-包装选项卡。

### 例子

让我们举一个例子来演示动画选项卡在 Framework7 中的使用:
                        ...
                        <div class = "tabs">
                           ...
                           <div id = "tab1" class = "tab active">
                              <div class = "content-block">
								 ...
								 PHP, .Net, Hadoop, Data Analytics, R Programming, SAP, Android, Python, 
...
[Test it Now](https://www.javatpoint.com/oprweb/test.jsp?filename=framework7animatedtabs)