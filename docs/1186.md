...
Angular flex-layout 是由 Angular 团队开发的独立库，用于设计复杂的布局。Angular布局使用 Flexbox 提供了一个复杂的应用编程接口。该模块使用自定义布局应用编程接口为 Angular 开发人员提供组件布局功能。
