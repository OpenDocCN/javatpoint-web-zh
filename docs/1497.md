...
> 原文:[https://www.javatpoint.com/materialize-css-collections](https://www.javatpoint.com/materialize-css-collections)

物化 CSS 集合便于您将列表对象组合在一起。它代表各种类型的集合，其中集合是一组相关的信息项。
