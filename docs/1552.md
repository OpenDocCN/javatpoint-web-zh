# 框架 7 标签 JavaScript 事件

> 原文:[https://www . javatpoint . com/framework 7-选项卡-JavaScript-事件](https://www.javatpoint.com/framework7-tabs-javascript-events)

您可以为 Framework7 中的选项卡使用 JavaScript 代码。

### 例子

让我们举一个例子来演示框架 7 中标签的 JavaScript 事件的使用。
